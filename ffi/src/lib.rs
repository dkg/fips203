...
#[no_mangle]
pub extern "C" fn ml_kem_512_keygen(encaps_out: &mut ml_kem_512_encaps_key,
                                    decaps_out: &mut ml_kem_512_decaps_key) -> bool {
...
#[no_mangle]
pub extern "C" fn ml_kem_512_encaps(encaps: &ml_kem_512_encaps_key,
                                    ciphertext_out: &mut ml_kem_512_ciphertext,
                                    shared_secret_out: &mut ml_kem_shared_secret) -> bool {
...
#[no_mangle]
pub extern "C" fn ml_kem_512_decaps(decaps: &ml_kem_512_decaps_key,
                                    ciphertext: &ml_kem_512_ciphertext,
                                    shared_secret_out: &mut ml_kem_shared_secret) -> bool {
...
#[no_mangle]
pub extern "C" fn ml_kem_768_keygen(encaps_out: &mut ml_kem_768_encaps_key,
                                    decaps_out: &mut ml_kem_768_decaps_key) -> bool {
    use fips203::traits::{KeyGen, SerDes};
...
#[no_mangle]
pub extern "C" fn ml_kem_768_encaps(encaps: &ml_kem_768_encaps_key,
                                    ciphertext_out: &mut ml_kem_768_ciphertext,
                                    shared_secret_out: &mut ml_kem_shared_secret) -> bool {
    use fips203::traits::{Encaps, SerDes};
...
#[no_mangle]
pub extern "C" fn ml_kem_768_decaps(decaps: &ml_kem_768_decaps_key,
                                    ciphertext: &ml_kem_768_ciphertext,
                                    shared_secret_out: &mut ml_kem_shared_secret) -> bool {
    use fips203::traits::{Decaps, SerDes};
...
#[no_mangle]
pub extern "C" fn ml_kem_1024_keygen(encaps_out: &mut ml_kem_1024_encaps_key,
                                    decaps_out: &mut ml_kem_1024_decaps_key) -> bool {
    use fips203::traits::{KeyGen, SerDes};
...
#[no_mangle]
pub extern "C" fn ml_kem_1024_encaps(encaps: &ml_kem_1024_encaps_key,
                                    ciphertext_out: &mut ml_kem_1024_ciphertext,
                                    shared_secret_out: &mut ml_kem_shared_secret) -> bool {
    use fips203::traits::{Encaps, SerDes};
...
#[no_mangle]
pub extern "C" fn ml_kem_1024_decaps(decaps: &ml_kem_1024_decaps_key,
                                    ciphertext: &ml_kem_1024_ciphertext,
                                    shared_secret_out: &mut ml_kem_shared_secret) -> bool {
    use fips203::traits::{Decaps, SerDes};
